    ...
    return (
        <div className="piano-container">
            <div className="piano-content">
                ...
                <div className={"black-key" + (isKeyPlayed("Db4") ? " black-key-played" : "")}>W</div> {/*Db4*/}
                <div className={"white-key" + (isKeyPlayed("D4") ? " white-key-played" : "")}>S</div> {/*D4*/}
                <div className={"black-key" + (isKeyPlayed("Eb4") ? " black-key-played" : "")}>E</div> {/*Eb4*/}
                ...
                <div className={"black-key" + (isKeyPlayed("Gb4") ? " black-key-played" : "")}>T</div> {/*Gb4*/}
                <div className={"white-key" + (isKeyPlayed("G4") ? " white-key-played" : "")}>G</div> {/*G4*/}
                <div className={"black-key" + (isKeyPlayed("Ab4") ? " black-key-played" : "")}>Y</div> {/*Ab4*/}
                <div className={"white-key" + (isKeyPlayed("A4") ? " white-key-played" : "")}>H</div> {/*A4*/}
                <div className={"black-key" + (isKeyPlayed("Bb4") ? " black-key-played" : "")}>U</div> {/*Bb4*/}
                ...
                <div className={"black-key" + (isKeyPlayed("Db5") ? " black-key-played" : "")}></div> {/*Db5*/}
                <div className={"white-key" + (isKeyPlayed("D5") ? " white-key-played" : "")}></div> {/*D5*/}
                <div className={"black-key" + (isKeyPlayed("Eb5") ? " black-key-played" : "")}></div> {/*Eb5*/}
                ...
                <div className={"black-key" + (isKeyPlayed("Gb5") ? " black-key-played" : "")}></div> {/*Gb5*/}
                <div className={"white-key" + (isKeyPlayed("G5") ? " white-key-played" : "")}></div> {/*G5*/}
                <div className={"black-key" + (isKeyPlayed("Ab5") ? " black-key-played" : "")}></div> {/*Ab5*/}
                <div className={"white-key" + (isKeyPlayed("A5") ? " white-key-played" : "")}></div> {/*A5*/}
                <div className={"black-key" + (isKeyPlayed("Bb5") ? " black-key-played" : "")}></div> {/*Bb5*/}
